...
# # Load user data from JSON file (as a single dictionary)
# def load_user_data():
...
# # Save user data to JSON file (saving the entire dictionary)
...
#     role = st.selectbox("Select Role", ["Student", "Librarian", "Admin"])
...
#             # Page switching based on role after successful login
...
#     # Choice between login or signup
